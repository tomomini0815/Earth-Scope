  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          予期しないエラーが発生しました。再読み込みするか、トップページにお戻りください。
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "EarthScope (ES) — インタラクティブ世界地図で学ぶ地理・歴史・統計" },
      { property: "og:description", content: "全世界198ヵ国の統計・詳細歴史年表・文化・国旗・入試受験ポイントを学ぶインタラクティブ世界地図学習プラットフォーム EarthScope (ES)。" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@EarthScope" },
    ],
    links: [
